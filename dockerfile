...
COPY --from=builder /yggdrasil/public ./public
COPY --from=builder /yggdrasil/package.json ./package.json
COPY --from=builder /yggdrasil/.next/standalone ./
COPY --from=builder /yggdrasil/.next/static ./.next/static
COPY --from=builder /yggdrasil/run.sh ./run.sh
